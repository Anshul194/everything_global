...
const accordionItems = [
    {
        ...
        content: "Our email marketing strategies help you stay connected with your audience, build relationships, and drive repeat business with personalized campaigns.",
        content1:"",
        type: "Build a memorable brand identity.",
        headering: "Nurture Leads and Boost Conversions with Our Email Marketing Services",
        img: "/image/home/accordion1.jpg",
        color: "#cbdec6"
    },
    {
        id: "",
        title: "Your audience, in their inbox.",
        content: "Stay top of mind and build customer loyalty with personalized email campaigns. From promotions to newsletters, our emails nurture leads and encourage repeat business.",
        type: "design",
        headering: "Nurture leads and boost conversions.",
