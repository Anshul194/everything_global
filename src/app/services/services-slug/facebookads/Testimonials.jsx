            ...
            <Slider {...settings}>
                ...
                <div className={`relative mb-[40px]`}>
                    ...
                    <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                        ...
                        <div className={`text-black/90 text-sm sm:text-base`}>
                            <p>Everything Globle’s Facebook Ads services have been a game-changer. They helped us target the right audience with precision, and the results have been fantastic in terms of engagement and conversions.</p>
                        </div>
                    </div>
                ...
                <div className={`relative mb-[40px]`}>
                    ...
                    <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                        ...
                        <div className={`text-black/90 text-sm sm:text-base`}>
                            <p>We’ve seen incredible results from our Facebook Ads campaign with Everything Globle. Their targeted approach really helped us connect with new customers and grow our brand awareness.</p>
                        </div>
                    </div>
                    <div className="absolute -bottom-5 -right-0 border border-black bg-[#cbdec6] rounded-xl p-3">
                        <MdFormatQuote className='text-3xl' />
                ...
                <div className={`relative mb-[40px]`}>
                    ...
                    <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                        ...
                        <div className={`text-black/90 text-sm sm:text-base`}>
                            <p>Everything Globle’s Facebook Ads campaigns are the best we’ve ever had. They were able to optimize every aspect, from targeting to creatives, resulting in higher engagement and more sales.</p>
                        </div>
                    </div>
                    <div className="absolute -bottom-5 -right-0 border border-black bg-[#cbdec6] rounded-xl p-3">
                        <MdFormatQuote className='text-3xl' />
