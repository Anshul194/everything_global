            ...
            <Slider {...settings}>
                ...
                <div className={`relative mb-[40px]`}>
                    ...
                    <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                        ...
                        <div className={`text-black/90 text-sm sm:text-base`}>
                            <p>Everything Globle has been a key partner in growing our YouTube channel. They helped create a tailored strategy that has increased our subscribers and engagement dramatically.</p>
                        </div>
                    </div>
                ...
                <div className={`relative mb-[40px]`}>
                    ...
                    <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                        ...
                        <div className={`text-black/90 text-sm sm:text-base`}>
                            <p>The YouTube marketing strategy Everything Globle developed for us was exactly what we needed. Their approach has increased our channel views and helped us grow a loyal audience.</p>
                        </div>
                    </div>
                    <div className="absolute -bottom-5 -right-0 border border-black bg-[#cbdec6] rounded-xl p-3">
                        <MdFormatQuote className='text-3xl' />
                ...
                <div className={`relative mb-[40px]`}>
                    ...
                    <div className={`border border-black w-[80%] ml-auto -mt-14 relative bg-white flex flex-col justify-start space-y-4 p-4 sm:p-8 rounded-2xl`}>
                        ...
                        <div className={`text-black/90 text-sm sm:text-base`}>
                            <p>Everything Globle took our YouTube presence to the next level. Their content strategy and optimization techniques have resulted in more views, higher subscriber growth, and stronger audience interaction.</p>
                        </div>
                    </div>
                    <div className="absolute -bottom-5 -right-0 border border-black bg-[#cbdec6] rounded-xl p-3">
                        <MdFormatQuote className='text-3xl' />
