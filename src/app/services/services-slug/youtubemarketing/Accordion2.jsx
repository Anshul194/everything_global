...
const accordionItems = [
    {
        ...
        content: "Our YouTube marketing strategies help you build a strong channel presence, engage viewers, and turn your content into a powerful brand asset.",
        type: "Create captivating brand visuals.",
        headering: "Give Your Brand a Visual Edge with Our Creative Graphic Design Services",
    ...
    },
    {
        ...
        content: "Grow your brand with YouTube content that engages and informs. We help create video strategies that build your subscriber base and make a lasting impression on viewers.",
        type: "design",
        headering: "Grow Your Brand with Our YouTube Marketing Services",
