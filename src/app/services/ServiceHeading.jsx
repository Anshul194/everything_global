...
export default function ServiceHeading() {
    return (
        <>
            <div className={`custom_container grid lg:grid-cols-12 sm:px-12`}>
                <div className={`col-span-8 relative`}>
                    <h1 className='text-6xl sm:text-6xl font-semibold relative z-10 w-fit'>For Creatives With A <br />
                        Everything Globle
                        <span className={`absolute hidden sm:block z-0 -right-20 bottom-10`}>
                ...
                <div className={`hidden lg:block col-span-4 `}>
                    {/* <img src="/image/portfoilo/banner-right.png" alt="Error" className='animate_zoom_in delay-1000' /> */}
                    <div className="relative">
                        <div className='flex gap-x-20 w-full'>
                            <img src="/image/services/h1-newsletter-img3.webp" alt="Error" className='w-[100px] object-contain animate_zoom_in delay-1000' />
                            <img src="/image/services/h2-offset-img1.png" alt="Error" className='w-[130px] object-contain animate_zoom_in delay-500' />
                        </div>
                        <div className='flex gap-x-28 mt-8 '>
                            <img src="/image/services/land-offset-img.png" alt="Error" className='relative object-contain top-9 w-[70px] left-12 animate_zoom_in delay-500' />
                            <img src="/image/services/land-offset-img1.png" alt="Error" className='w-[50px] animate_zoom_in delay-1000' />
                        </div>
                    </div>
                </div>
            </div>
