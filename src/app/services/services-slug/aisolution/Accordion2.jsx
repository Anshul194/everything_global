...
const accordionItems = [
    {
        ...
        content: "Our SEO services help your business rank higher, attract the right traffic, and convert visitors into loyal customers. From technical audits to content optimization, we cover every aspect needed to grow your online presence organically.",
        content1:"",
        type: "Build a memorable brand identity.",
        headering: "Boost Your Online Visibility with Proven SEO Strategies",
        img: "/image/home/accordion1.jpg",
        color: "#cbdec6"
    },
    {
        id: "",
        title: "Rank smarter, grow faster.",
        content: "Whether it's on-page, off-page, or technical SEO, we craft data-driven strategies that improve search rankings, increase visibility, and bring your ideal customers straight to your site.",
        type: "design",
        headering: "Drive traffic that matters",
                        ...
                        <div className={`flex justify-between w-full text-lg  font-medium text-left focus:outline-none pb-2 sm:pb-10 lg:pb-20 ${index === accordionItems.length - 1 ? 'max-sm:!pb-0' : ''
                            ...
                            <div className={`flex justify-between w-full`}>
                                <div className={`flex flex-wrap gap-1 gap-x-20 sm:gap-6 items-start`}>
                                    <h2 className={`uppercase text-3xl sm:text-4xl md:text-6xl lg:!text-[75px] break-words lg:leading-[75px] break-words font-black`} style={{
