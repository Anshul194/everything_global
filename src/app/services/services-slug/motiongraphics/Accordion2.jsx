...
const accordionItems = [
    {
        ...
        content: "Our motion graphics services bring your brand messages to life, making them dynamic, engaging, and unforgettable.",
        content1:"",
        type: "Build a memorable brand identity.",
        headering: "Add Dynamic Appeal to Your Brand with Our Motion Graphics Services",
    ...
    },
    {
        ...
        content: "Make your brand messages dynamic and memorable with motion graphics. From animated logos to explainer videos, motion adds a lively edge that captures attention and holds it.",
        type: "design",
        headering: "Add dynamic visual appeal.",
